...
{
    public class RavenMicroController : IndividualMicroController
    {
        ...
        {
            // TODO: make FlyingDetectorMicroController, inherit from that and change observer to also inherit from it
        }
