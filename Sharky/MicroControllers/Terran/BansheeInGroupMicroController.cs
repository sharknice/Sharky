namespace Sharky.MicroControllers.Terran
{
    public class BansheeInGroupMicroController : BansheeMicroController
    {
        ...
        {
            if ((commander.UnitCalculation.TargetPriorityCalculation.TargetPriority == TargetPriority.KillWorkers || CloakedAndUndetected(commander)) && commander.UnitCalculation.NearbyEnemies.Count(e => e.UnitClassifications.Contains(UnitClassification.Worker)) > 1)
            {
