...
namespace Sharky.MicroControllers.Protoss
{
    public class DisruptorPhasedMicroController : IndividualMicroController
    {
        ...
        public DisruptorPhasedMicroController(MapDataService mapDataService, UnitDataManager unitDataManager, IUnitManager unitManager, DebugManager debugManager, IPathFinder sharkyPathFinder, SharkyOptions sharkyOptions, MicroPriority microPriority, bool groupUpEnabled)
