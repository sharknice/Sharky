...
namespace Sharky.EnemyStrategies.Protoss
{
    public class ProxyStargate : EnemyStrategy
    {
        ...
        public ProxyStargate(EnemyStrategyHistory enemyStrategyHistory, ChatService chatService, ActiveUnitData activeUnitData, SharkyOptions sharkyOptions, DebugService debugService, UnitCountService unitCountService, TargetingData targetingData)
        {
