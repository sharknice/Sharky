    ...
    public class TrainingDataService
    {
        public Dictionary<UnitTypes, TrainingTypeData> TrainingData()
        {
            return new Dictionary<UnitTypes, TrainingTypeData>
            {
                ...
                { UnitTypes.PROTOSS_MOTHERSHIP, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.PROTOSS_NEXUS }, Minerals = 300, Gas = 300, Food = 6, Ability = Abilities.TRAIN_MOTHERSHIP } },
                ...
                { UnitTypes.PROTOSS_WARPPRISM, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.PROTOSS_ROBOTICSFACILITY }, Minerals = 250, Food = 2, Ability = Abilities.TRAIN_WARPPRISM } },
                ...
                { UnitTypes.PROTOSS_VOIDRAY, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.PROTOSS_STARGATE }, Minerals = 250, Gas = 150, Food = 4, Ability = Abilities.TRAIN_VOIDRAY } },
                ...
                { UnitTypes.ZERG_QUEEN, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.ZERG_HATCHERY, UnitTypes.ZERG_LAIR, UnitTypes.ZERG_HIVE }, Minerals = 150, Food = 2, Ability = Abilities.TRAIN_QUEEN } },
                ...
                { UnitTypes.ZERG_BROODLORD, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.ZERG_CORRUPTOR }, Minerals = 150, Gas = 150, Food = 2, Ability = Abilities.MORPH_BROODLORD } },
                { UnitTypes.ZERG_OVERSEER, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.ZERG_OVERLORD }, Minerals = 50, Gas = 50, Ability = Abilities.MORPH_OVERSEER } },
                { UnitTypes.ZERG_OVERLORDTRANSPORT, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.ZERG_OVERLORD }, Minerals = 25, Gas = 25, Ability = Abilities.MORPH_OVERLORDTRANSPORT } },
            };
        }
    }
}
