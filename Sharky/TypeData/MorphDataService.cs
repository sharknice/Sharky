    ...
    public class MorphDataService
    {
        public Dictionary<UnitTypes, TrainingTypeData> MorphData()
        {
            return new Dictionary<UnitTypes, TrainingTypeData>
            {
                ...
                { UnitTypes.ZERG_LAIR, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.TERRAN_COMMANDCENTER }, Minerals = 150, Gas = 100, Ability = Abilities.MORPH_LAIR } },
                { UnitTypes.ZERG_HIVE, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.TERRAN_COMMANDCENTER }, Minerals = 200, Gas = 150, Ability = Abilities.MORPH_HIVE } },
            };
        }
    }
}
