...
namespace Sharky.Builds.BuildingPlacement
{
    public class WarpInPlacement : IBuildingPlacement
    {
        ...
        public Point2D FindPlacement(Point2D target, UnitTypes unitType, int size, bool ignoreMineralProximity = true, float maxDistance = 50, bool requireSameHeight = false)
        {
