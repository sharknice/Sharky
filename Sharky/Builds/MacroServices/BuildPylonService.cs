...
namespace Sharky.Builds.MacroServices
{
    public class BuildPylonService
    {
        ...
        public BuildPylonService(MacroData macroData, BuildingBuilder buildingBuilder, UnitDataManager unitDataManager, UnitManager unitManager, BaseManager baseManager, TargetingManager targetingManager)
        {
            MacroData = macroData;
            BuildingBuilder = buildingBuilder;
            UnitDataManager = unitDataManager;
