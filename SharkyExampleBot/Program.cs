...
namespace SharkyExampleBot
{
    class Program
    {
        ...
        static BuildChoices GetProtossBuildChoices(DefaultSharkyBot defaultSharkyBot)
        {
            ...
            var zealotRush = new ZealotRush(defaultSharkyBot.BuildOptions, defaultSharkyBot.MacroData, defaultSharkyBot.ActiveUnitData, defaultSharkyBot.AttackData, defaultSharkyBot.ChatService, defaultSharkyBot.ChronoData, protossCounterTransitioner, defaultSharkyBot.MicroTaskData, defaultSharkyBot.UnitCountService);
            ...
            var buildNothing = new BuildNothing(defaultSharkyBot.BuildOptions, defaultSharkyBot.MacroData, defaultSharkyBot.ActiveUnitData, defaultSharkyBot.AttackData, defaultSharkyBot.ChatService, defaultSharkyBot.UnitCountService);
